...
answers = Answer.create([
  { body: 'Для создания файлов используйте команду touch', correct: true, question: questions[2]},
  ...
  { body: 'Локальные, глобальные, переменные инстенса и класса', correct: true, question: questions[3]},
  { body: 'Это менеджер для управления зависимостями gem-ов в ruby приложениях', correct: true, question: questions[4]},
  ...
  { body: 'Абстракция, наследование, инкапсуляция, полиморфизм', correct: true, question: questions[0]}
])
